...
const ButtonStyle = styled.button<Omit<Props, 'isLoading'>>`
    ${tw`relative inline-flex items-center justify-center rounded-md text-sm font-medium transition-all duration-150`};

    ${(props) =>
        ((!props.isSecondary && !props.color) || props.color === 'primary') &&
        css<Props>`
            ${(props) => !props.isSecondary && tw`bg-primary-500 text-white`};
    ...
    ${(props) =>
        ...
        css<Props>`
            ...
            &:hover:not(:disabled) {
                ...
                ${(props) => props.color === 'primary' && tw`bg-primary-500 border-primary-600 text-white`};
