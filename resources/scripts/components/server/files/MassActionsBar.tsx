                ...
                <Portal>
                    <div className={'pointer-events-none fixed bottom-0 mb-6 flex justify-center w-full z-50'}>
                        <Fade timeout={75} in={selectedFiles.length > 0} unmountOnExit>
                            <div
                                css={tw`flex items-center gap-3 pointer-events-auto rounded-2xl px-5 py-3 border border-white/10`}
                                style={{ background: 'rgba(12,12,15,0.92)', backdropFilter: 'blur(16px)', boxShadow: '0 8px 32px rgba(0,0,0,0.5)' }}
                            >
                                <span css={tw`text-xs text-neutral-400 mr-1 select-none`}>
