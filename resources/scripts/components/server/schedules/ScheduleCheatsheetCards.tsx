...
export default () => {
    return (
        <>
            <div css={tw`md:w-1/2 h-full bg-black/30 rounded-lg`}>
                <div css={tw`flex flex-col`}>
                    <h2 css={tw`py-4 px-6 font-bold text-neutral-200`}>Examples</h2>
                    <div css={tw`flex py-4 px-6 bg-white/5`}>
            ...
            <div css={tw`md:w-1/2 h-full bg-black/30 rounded-lg`}>
                <h2 css={tw`py-4 px-6 font-bold text-neutral-200`}>Special Characters</h2>
                <div css={tw`flex flex-col`}>
                    <div css={tw`flex py-4 px-6 bg-white/5`}>
