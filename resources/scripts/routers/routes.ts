...
import PlanContainer from '@/components/server/plan/PlanContainer';
...
import CreditHistoryContainer from '@/components/dashboard/CreditHistoryContainer';
...
export default {
    ...
    server: [
        ...
        {
            path: '/plan',
            permission: 'settings.change-plan',
            name: 'Plan',
