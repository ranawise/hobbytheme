    ...
    <form action="{{ route('admin.users.view', $user->id) }}" method="post">
        ...
        <div class="col-md-6">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label for="credits" class="control-label">Credit Balance</label>
                        <div>
                            <input type="number" min="0" step="1" id="credits" name="credits" value="{{ old('credits', $user->credits) }}" class="form-control">
                            <p class="text-muted"><small>
                                This user currently has {{ $user->free_server_slots }} free server
                                slot(s){{ $user->free_server_slots > 1 ? ' (purchased with credits)' : '' }}.
                                Users spend 500 credits to buy each additional slot.
                            </small></p>
                        </div>
                    </div>
                </div>
