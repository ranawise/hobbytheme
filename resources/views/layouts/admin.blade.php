            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.icons') ?: 'active' }}">
                            <a href="{{ route('admin.icons') }}">
                                <i class="fa fa-image"></i> <span>Icons</span>
                            </a>
                        </li>
                        ...
                        <li class="{{ Route::currentRouteName() !== 'admin.servers.free' ? '' : 'active' }}">
                            <a href="{{ route('admin.servers.free') }}">
                                <i class="fa fa-gift"></i> <span>Free Servers</span>
                            </a>
                        </li>
